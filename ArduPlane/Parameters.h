...
public:
    ...
    enum {
       ...
       // k_param_aero_lthr_rthr,
        ...
        // MJS
        k_param_aero_ctrl_chan,
        k_param_aero_min_alt,
        k_param_aero_elev_ail,
    ...
    //MJS
    AP_Int8 aero_ctrl_chan;
    AP_Int16 aero_min_alt;
    AP_Int32 aero_elev_ail;
  //  AP_Int32 aero_lthr_rthr;
};
...
public:
  ...
  //  AP_Int16 aero_loop_thr;
//
//    AP_Int16 aero_roll_thr;
