...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Param: AERO_CTRL_CHAN
    // @DisplayName: Control Channel and flags for Aerobatics
    // @Description: This specifies the channel for controlling aerobatics, 0 to disable
    // @Values:Bits 0-3  0:Disabled,5-8:Enabled, bit 4 use mission control
    // @User: Advanced
    GSCALAR(aero_ctrl_chan,    "AERO_CTRL_CHAN",   0),

    // @Param: AERO_MIN_ALT
    // @DisplayName: Minimum altitude for aerobatics
    // @Description: If altitude is less than this abort the manuever
    // @Values: altitude in meters
    // @User: Advanced
    GSCALAR(aero_min_alt,    "AERO_MIN_ALT",   0),


    // @Param: AERO_ELEV_AIL
    // @DisplayName: Elevator setting for a loop*1000, aileron setting for roll
    // @Description: Elevator setting in us for loop*1000, aileron setting for roll e.g 17001800
    // @Values: 1000-2000 1000-2000
    // @User: Advanced
    GSCALAR(aero_elev_ail,    "AERO_ELEV_AIL",   0),

//    // @Param: AERO_LTHR_RTHR
//     // @DisplayName: throttle for loop and roll
//     // @Description: This specifies the channel for controlling aerobatics, 0 to disable
//     // @Values:Bits 0-3  0:Disabled,5-8:Enabled, bit 4 use mission control
//     // @User: Advanced
//     GSCALAR(aero_lthr_rthr,    "AERO_LTHR_RTHR",   19001800),
...
//        // @Param: AERO_LOOP_THR
//        // @DisplayName: Set throttle for aerobatic loop
//        // @Description: Specify throttle for aerobatic roll
//        // @Values: 1000 to 2000 pwm setting for roll aileron
//        // @User: Advanced
//        AP_GROUPINFO("AERO_LOOP_THR",11, ParametersG2,aero_loop_thr,   1501),
//
//
//        // @Param: AERO_ROLL_THR
//        // @DisplayName: Set throttle for aerobatic roll
//        // @Description:  Specify throttle for aerobatic roll
//        // @Values: 1000 to 2000 pwm setting for roll aileron
//        // @User: Advanced
//        AP_GROUPINFO("AERO_ROLL_THR",12, ParametersG2,aero_roll_thr,  1503),

//        AP_GROUPINFO("TEST1",13, ParametersG2,test1,  1601),
//        AP_GROUPINFO("TEST2",14, ParametersG2,test2,  1602),
//        AP_GROUPINFO("TEST3",15, ParametersG2,test3,  1603),
//        AP_GROUPINFO("TEST4",16, ParametersG2,test4,  1604),
...
//        // @Values: 1000 to 2000 pwm setting for roll aileron
//        // @User: Advanced
//        AP_GROUPINFO("AERO_LOOP_THR",1, ParametersG3,aero_loop_thr,   1501),
//
//
//        // @Param: AERO_ROLL_THR
//        // @DisplayName: Set throttle for aerobatic roll
...
//        // @Values: 1000 to 2000 pwm setting for roll aileron
//        // @User: Advanced
//        AP_GROUPINFO("AERO_ROLL_THR",2, ParametersG3,aero_roll_thr,  1503),
//
////        AP_GROUPINFO("TEST1",13, ParametersG2,test1,  1601),
////        AP_GROUPINFO("TEST2",14, ParametersG2,test2,  1602),
////        AP_GROUPINFO("TEST3",15, ParametersG2,test3,  1603),
